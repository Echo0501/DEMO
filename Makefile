...
OpenSimplexNoise.o: OpenSimplexNoise.cpp OpenSimplexNoise.h Makefile
	$(CC) $(CFLAGS) -c $< -lm

NoobSDL.o: NoobSDL.c NoobSDL.h Makefile
	$(CC) $(CFLAGS) -c $< `sdl2-config --cflags --libs`

cube.o: cube.c vec.h geom.h cube.h Makefile
	$(CC) $(CFLAGS) -c $<

geom.o: geom.c vec.h geom.h cube.h Makefile
	$(CC) $(CFLAGS) -c $< -lm

vec.o: vec.c vec.h Makefile
	$(CC) $(CFLAGS) -c $< -lm

main.o: main.cpp vec.h geom.h cube.h NoobSDL.h OpenSimplexNoise.h Makefile
