...
void marching_cube(float A, float B, float C, float D, 
	...
	switch (cube_index) {
		...
		case 0x01:
			*tri_count = 1;
			*tri_list = (struct triangle_t *)  malloc(sizeof(struct triangle_t) * 1);
		...
		case 0x03:
			*tri_count = 2;
			*tri_list = (struct triangle_t *)  malloc(sizeof(struct triangle_t) * 2);
		...
		case 0x07:
			*tri_count = 3;
			*tri_list = (struct triangle_t *)  malloc(sizeof(struct triangle_t) * 3);
		...
		case 0x17:
			*tri_count = 4;
			*tri_list = (struct triangle_t *)  malloc(sizeof(struct triangle_t) * 4);
		...
		case 0x3D:
			*tri_count = 5;
			*tri_list = (struct triangle_t *)  malloc(sizeof(struct triangle_t) * 5);
